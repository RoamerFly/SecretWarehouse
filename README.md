...
SecretWarehouse 是一款基于 **Tauri + React + TypeScript** 构建的跨平台桌面密码管理应用。它采用 **AES-256-GCM 加密算法**，将您的敏感数据安全存储在本地数据库中，无需依赖云端服务，从根源上保护您的隐私。
...
| 🔐 **军事级加密** | 使用 AES-256-GCM 算法加密敏感字段 |
| 🎨 **现代界面** | 简洁美观的 UI，支持亮色/暗色主题 |
| 🚀 **原生性能** | Tauri 提供接近原生的启动速度和运行效率 |
| 📦 **开箱即用** | 内置常用密码模板，快速创建条目 |
